...
<title>iAttendance : Student Details</title>
<style>
	html {
...
<body>
    <div class="container">
        ...
        try {
            ...
            String sql;
            sql = "SELECT stud_id, name, phone_no, gender, d_name FROM student";
...
<div class="options">
    <button onclick="location.href='insert_student.jsp'">Insert New Student</button>
    <button onclick="location.href='update_student.jsp'">Update Student</button>
    <button onclick="location.href='delete_student.jsp'">Delete Student</button>
</div>
</div>
</body>
</html>